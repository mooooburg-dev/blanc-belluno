...
- **홈페이지** — 히어로 슬라이더, 서비스 소개, 갤러리, 진행방식, 상담 문의폼, 인스타그램 피드
- **서비스 상세** (`/services/[slug]`) — 카테고리별 소개·하이라이트·작업 사례
- **포트폴리오** — 8개 카테고리(아치/반아치, 숫자 타워, 돌잔치, 생신연, 기업 행사, 파티, 졸업·입학식, 웨딩·프로포즈)별 작업물 갤러리, 라이트박스 모달 지원
